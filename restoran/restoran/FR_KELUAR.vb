...
Public Class FR_KELUAR
    ...
    Sub masuk_data()
        ...
        Else
            ...
            dgtampil.Rows(dgtampil.Rows.Count - 1).Cells("STATUS").Value = TXTSATUAN.Text
    ...
    Private Sub txtcari_TextChanged(sender As Object, e As EventArgs) Handles txtcari.TextChanged
        Dim str As String = "select TOP 10 rtrim(kode) as KODE,rtrim(barang) as MENU,rtrim(satuan)" &
    ...
    Sub masuk_database()
        ...
        For Each erow As DataGridViewRow In dgtampil.Rows
            ...
            Dim str As String = "insert into tbl_transaksi (kode,jumlah,status,harga,tgl,kasir) VALUES" & _
    ...
    Private Sub nota_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles nota.PrintPage
        ...
        tinggi = tinggi + 10
        e.Graphics.DrawString("Terimakasih-Silahkan datang kembali!", New Drawing.Font("courier new", 8), Brushes.Black, 2, tinggi)
    End Sub
